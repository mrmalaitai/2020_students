...
def calculate_scores(current_year, final_races):
    ...
    #converting into dictionary to list
    #list = [(k, v) for k, v in clubs.items()]
    
    # Orders the list using the second position which is the score 
...
#this code gives me the button to display the waka ama comp points 
